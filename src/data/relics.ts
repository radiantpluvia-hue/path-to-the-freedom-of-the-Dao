export interface Relic {
  ...
  rarity: 'Mythic' | 'Transcendent' | 'Legendary';
  description: string;
  lore: string;
  stats?: { atk?: number; def?: number; hp?: number; qi?: number; crit?: number };
  passives?: string[]; // references existing or generated passive ids
  unique?: boolean; // world-unique
  source?: string; // character / saga inspiration
}
