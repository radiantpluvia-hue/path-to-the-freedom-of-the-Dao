...
export const KID_GOD_RIVAL: Rival = {
  id: 'kid_god_taek_jin',
  name: 'Kid God (Taek Jin)',
  title: 'Heaven-born Prodigy',
  description:
    "A heaven-defying prodigy trained in Recoilless Taekwondo. Playful yet terrifyingly skilled, he fights with a polearm and devastating kicks.",
  faction: 'independent',
...
export const HIDDEN_RIVALS = [KID_GOD_RIVAL];
