/* eslint-disable no-restricted-imports -- story data references systems for wiring */
import { StoryAct, StoryEvent } from './systems/StorySystem';

// Act 1 Events (from act1_events.json)
const act1Events: StoryEvent[] = [
  {
