...
exports.checkForEvolutions = void 0;
exports.getRequiredQiForBreakthrough = getRequiredQiForBreakthrough;
exports.getCultivationGainPerDay = getCultivationGainPerDay;
exports.cultivate = cultivate;
exports.tryBreakthrough = tryBreakthrough;
...
function getRequiredQiForBreakthrough(currentRealm) {
...
function getCultivationGainPerDay(state, baseRate = 10) {
...
function cultivate(state, days = 1, baseRate = 10) {
...
function tryBreakthrough(state) {
...
const checkForEvolutions = () => {
    return [];
};
exports.checkForEvolutions = checkForEvolutions;
