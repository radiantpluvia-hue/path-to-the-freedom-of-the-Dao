...
exports.RivalSystemNullReferenceDemo = void 0;
 ...
 */
class RivalSystemNullReferenceDemo {
    constructor() {
        this.rivalSystem = new RivalSystem_1.RivalSystem();
        this.sectFactionSystem = new SectSystem_1.SectFactionSystem(this.rivalSystem);
    }
    /**
    ...
    demoLootGeneration() {
        ...
        const lootNull = this.rivalSystem.generateArchetypeLoot(mockArchetypeNullLoot, SectSystem_2.MAJOR_SECTS[0], 10);
        ...
        const lootIncomplete = this.rivalSystem.generateArchetypeLoot(mockArchetypeIncomplete, SectSystem_2.MAJOR_SECTS[0], 10);
        ...
        const lootEmpty = this.rivalSystem.generateArchetypeLoot(mockArchetypeEmpty, SectSystem_2.MAJOR_SECTS[0], 10);
    ...
    demoSectFactionValidation() {
        ...
        console.log('Original array sizes:', {
            sects: SectSystem_2.MAJOR_SECTS.length,
            factions: SectSystem_2.MAJOR_FACTIONS.length
        });
        // Mock empty arrays
        global.MAJOR_SECTS = [];
...
exports.RivalSystemNullReferenceDemo = RivalSystemNullReferenceDemo;
// Export for use in other files
exports.default = RivalSystemNullReferenceDemo;
