...
exports.DailyLoopSystem = void 0;
class DailyLoopSystem {
    /**
     ...
     */
    static hasDayPassed(lastTimestamp) {
        if (!lastTimestamp)
            return true;
     ...
     */
    static resetDailyForPlayer(player) {
        if (!player)
            return player;
        try {
            // Reset common daily counters
            if (typeof player.dailyCultivationCount === 'number')
                player.dailyCultivationCount = 0;
...
exports.DailyLoopSystem = DailyLoopSystem;
DailyLoopSystem.ONE_DAY_MS = 24 * 60 * 60 * 1000;
