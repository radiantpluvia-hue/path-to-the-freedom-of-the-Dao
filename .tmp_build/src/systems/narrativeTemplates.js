...
exports.templateForEvent = templateForEvent;
            ...
            if (expr.startsWith('random(') && expr.endsWith(')')) {
                ...
                try {
                    if (Array.isArray(arr) && arr.length > 0)
                        return String((0, rng_1.choice)(arr) ?? '');
                }
                catch (e) { /* fall back */ }
                return '';
            }
...
function templateForEvent(eventId, fallback = 'generic_event') {
    return exports.TEMPLATES[eventId] || exports.TEMPLATES[fallback] || '';
}
