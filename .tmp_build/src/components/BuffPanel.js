...
const BuffPanel = () => {
    ...
    const [_tick, setTick] = (0, react_1.useState)(() => useGameStore_1.useGameStore.getState().world.tick || 0);
    (0, react_1.useEffect)(() => {
    ...
    return ((0, jsx_runtime_1.jsx)("aside", { className: "buff-panel", "aria-label": "Active buffs and skills", children: hasBuffs && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("div", { className: "buff-panel__header", children: [(0, jsx_runtime_1.jsx)("h4", { style: { margin: 0, fontSize: '1rem' }, children: "Active Buffs" }), (0, jsx_runtime_1.jsx)("div", { style: { fontSize: '0.85rem', color: 'var(--muted)' }, children: player.activeBuffs.length })] }), player.activeBuffs.map((b) => {
