...
const EnhancedQuestPanel = ({ quests, onQuestSelect, showType, maxQuests = 5 }) => {
        ...
        if (newlyCompleted.length > 0) {
            ...
            newlyCompleted.forEach(questId => {
                ...
                if (quest) {
                    ...
                    logger_1.logger.debug(`Quest completed: ${quest.title}`);
                }
            });
        }
    ...
    return ((0, jsx_runtime_1.jsx)(Card_1.Card, { title: `${getTypeIcon(showType || 'main')} ${showType ? showType.charAt(0).toUpperCase() + showType.slice(1) : 'Active'} Quests`, "aria-label": `${showType || 'Active'} quests list`, children: (0, jsx_runtime_1.jsx)("div", { style: { display: 'grid', gap: '12px' }, children: sortedQuests.map(quest => {
                ...
                return ((0, jsx_runtime_1.jsxs)("div", { style: {
                    ...
                    }, role: "button", tabIndex: 0, "aria-expanded": isSelected, onClick: () => handleQuestClick(quest.id), "aria-label": `${quest.title}, difficulty ${quest.difficulty}, ${isCompleted ? 'completed' : `${progress.completed} of ${progress.total} objectives`}`, onKeyDown: (e) => {
                        if (e.key === 'Enter' || e.key === ' ') {
                            e.preventDefault();
                            handleQuestClick(quest.id);
                        }
                    }, children: [(0, jsx_runtime_1.jsxs)("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '8px' }, children: [(0, jsx_runtime_1.jsxs)("div", { style: { flex: 1 }, children: [(0, jsx_runtime_1.jsxs)("div", { style: { display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }, children: [(0, jsx_runtime_1.jsx)("span", { style: { fontSize: '1.1rem', fontWeight: 'bold', color: 'var(--primary)' }, children: quest.title }), isCompleted && (0, jsx_runtime_1.jsx)(SmallChip_1.default, { variant: "success", style: { fontSize: '0.9rem' }, children: "\u2713" })] }), (0, jsx_runtime_1.jsxs)("div", { style: { display: 'flex', alignItems: 'center', gap: '8px', fontSize: '0.8rem' }, children: [(0, jsx_runtime_1.jsx)(SmallChip_1.default, { style: {
                                                        fontSize: '0.8rem',
                                                        background: getDifficultyColor(quest.difficulty),
                                                        color: 'white',
                                                        textTransform: 'uppercase',
                                                        fontWeight: 'bold'
                                                    }, children: quest.difficulty }), (0, jsx_runtime_1.jsx)(SmallChip_1.default, { style: { fontSize: '0.8rem', color: 'var(--muted)' }, children: quest.type.charAt(0).toUpperCase() + quest.type.slice(1) }), quest.experience > 0 && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("span", { style: { color: 'var(--muted)' }, children: "\u2022" }), (0, jsx_runtime_1.jsxs)(SmallChip_1.default, { variant: "accent", style: { fontSize: '0.8rem' }, children: [quest.experience, " XP"] })] }))] })] }), (0, jsx_runtime_1.jsxs)("div", { style: {
                                        fontSize: '0.9rem',
                                        color: 'var(--primary)',
                                        fontWeight: 'bold',
                                        minWidth: '60px',
                                ...
                                borderTop: '1px solid rgba(255, 255, 255, 0.1)'
                                                ...
                                                return ((0, jsx_runtime_1.jsxs)("div", { style: {
                                                        ...
                                                        gap: '8px',
                                                        fontSize: '0.85rem'
                                                    }, children: [(0, jsx_runtime_1.jsxs)(SmallChip_1.default, { variant: objective.isCompleted ? 'success' : 'neutral', style: { fontSize: '0.85rem', textDecoration: objective.isCompleted ? 'line-through' : 'none' }, children: [objective.isCompleted ? '\u2713' : '\u25cb', " ", objective.description] }), objective.isOptional && ((0, jsx_runtime_1.jsx)(SmallChip_1.default, { style: { color: 'var(--muted)', fontSize: '0.75rem', fontStyle: 'italic' }, children: "Optional" })), !objective.isCompleted && objProgress.target > 1 && ((0, jsx_runtime_1.jsxs)(SmallChip_1.default, { variant: "accent", style: { fontSize: '0.75rem', marginLeft: 'auto' }, children: [objProgress.current, "/", objProgress.target] }))] }, objective.id));
                                                ...
                                                gap: '6px',
                                                fontSize: '0.8rem'
                                            }, children: [quest.experience > 0 && ((0, jsx_runtime_1.jsxs)(SmallChip_1.default, { variant: "accent", style: { borderRadius: 4, fontSize: '0.8rem' }, children: [quest.experience, " XP"] })), quest.rewards.map((reward, index) => ((0, jsx_runtime_1.jsx)(SmallChip_1.default, { variant: "success", style: { borderRadius: 4, fontSize: '0.8rem' }, children: reward.description }, index)))] })] })), quest.timeLimit && quest.startedAt && ((0, jsx_runtime_1.jsxs)("div", { style: {
                                        marginTop: '8px',
                                        fontSize: '0.8rem',
                                        color: 'var(--danger)'
