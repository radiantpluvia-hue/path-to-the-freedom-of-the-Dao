...
const QuestManager = () => {
    ...
    return ((0, jsx_runtime_1.jsxs)(Card_1.Card, { title: "\uD83C\uDFAF Quest Manager", children: [(0, jsx_runtime_1.jsx)("div", { style: {
                    ...
                    paddingBottom: '12px'
                }, children: questCounts.map(tab => ((0, jsx_runtime_1.jsxs)("button", { onClick: () => setActiveTab(tab.id), style: {
                        ...
                        if (activeTab !== tab.id) {
                            ...
                            e.currentTarget.style.borderColor = 'transparent';
                    ...
                    }, children: [(0, jsx_runtime_1.jsx)("span", { children: tab.icon }), (0, jsx_runtime_1.jsx)("span", { children: tab.label }), (tab.activeCount > 0 || tab.availableCount > 0) && ((0, jsx_runtime_1.jsx)("span", { style: {
                                ...
                                minWidth: '18px',
                                textAlign: 'center'
                            }, children: tab.activeCount + tab.availableCount }))] }, tab.id))) }), (0, jsx_runtime_1.jsxs)("div", { style: { minHeight: '300px' }, children: [questsByType.length > 0 && ((0, jsx_runtime_1.jsxs)("div", { style: { marginBottom: '20px' }, children: [(0, jsx_runtime_1.jsxs)("h3", { style: {
                                    color: 'var(--primary)',
                                    fontSize: '1.1rem',
                                    marginBottom: '12px',
                                    display: 'flex',
                                    ...
                                    gap: '8px'
                                        ...
                                        transition: 'all 0.2s ease'
                                                        ...
                                                        marginBottom: '12px'
                                                            ...
                                                            }, children: quest.difficulty }), quest.experience > 0 && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("span", { style: { color: 'var(--muted)' }, children: "\u2022" }), (0, jsx_runtime_1.jsxs)("span", { style: { color: 'var(--accent)' }, children: [quest.experience, " XP"] })] })), quest.rewards.length > 0 && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("span", { style: { color: 'var(--muted)' }, children: "\u2022" }), (0, jsx_runtime_1.jsxs)("span", { style: { color: 'var(--success)' }, children: [quest.rewards.length, " Reward", quest.rewards.length > 1 ? 's' : ''] })] }))] }), quest.prerequisites && quest.prerequisites.length > 0 && ((0, jsx_runtime_1.jsxs)("div", { style: {
                                                        fontSize: '0.8rem',
                                                        color: 'var(--muted)',
                                                        marginBottom: '12px'
                                            ...
                                            }, children: "Start Quest" })] }, quest.id))) })] })), questsByType.length === 0 && availableQuestsForType.length === 0 && ((0, jsx_runtime_1.jsxs)("div", { style: {
                            textAlign: 'center',
                            color: 'var(--muted)',
                            padding: '40px 20px',
                            fontStyle: 'italic'
