...
const scalingSystem_ts_1 = require("../data/scalingSystem.ts");
// Mock GameStore
const mockGameStore = {
    player: {
        id: 'player',
...
function testRealmScalingBalance() {
    ...
    testRealms.forEach(realm => {
        const multiplier = (0, scalingSystem_ts_1.getRealmMultiplier)(realm);
        const scaledStats = {
...
function testEdgeCases() {
    ...
    const combatSystem = new CombatSystem_ts_1.CombatSystem(fastPlayer, [slowEnemy], mockGameStore, mockGameStore.rivalSystem, { type: 'normal' });
    ...
    try {
        const zeroCombat = new CombatSystem_ts_1.CombatSystem(zeroStatsPlayer, [slowEnemy], mockGameStore, mockGameStore.rivalSystem, { type: 'normal' });
