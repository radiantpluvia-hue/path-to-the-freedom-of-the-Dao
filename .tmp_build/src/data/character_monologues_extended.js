...
const dialogues_rivals_1 = __importDefault(require("./dialogues_rivals"));
const dialogues_bosses_1 = __importDefault(require("./dialogues_bosses"));
const dialogues_villains_1 = __importDefault(require("./dialogues_villains"));
const dialogues_cinematic_1 = __importDefault(require("./dialogues_cinematic"));
...
EXTENDED_MONOLOGUES.push(...dialogues_rivals_1.default);
EXTENDED_MONOLOGUES.push(...dialogues_bosses_1.default);
EXTENDED_MONOLOGUES.push(...dialogues_villains_1.default);
EXTENDED_MONOLOGUES.push(...dialogues_cinematic_1.default);
// Miscellaneous encounter and ambient lines (kept here for now)
EXTENDED_MONOLOGUES.push({ id: 'minion_scatter', title: 'Minion - Scatter', lines: [{ speaker: 'minion_c', text: 'Keep them crowded. They panic faster when they cannot breathe.' }], tags: ['minion', 'combat'] }, { id: 'minion_jeer', title: 'Minion - Jeer', lines: [{ speaker: 'minion_d', text: 'Run with your tail tucked. We sharpen knives on the backs of runners.' }], tags: ['minion', 'jeer'] }, { id: 'minion_cry_for_leader', title: 'Minion - Cry for Leader', mono: true, lines: [{ speaker: 'minion_e', text: 'For the master — for the ledger — for the coin that keeps our mouths fed.' }], tags: ['minion', 'grim'] }, { id: 'elite_guard_ritual', title: 'Elite Guard - Ritual', lines: [{ speaker: 'elite_guard', text: 'The sigils are walked; the oath is sworn. Fall now and be hushed by the bell.' }], tags: ['elite', 'ritual'] }, { id: 'elite_guard_last_stand', title: 'Elite Guard - Last Stand', mono: true, lines: [{ speaker: 'elite_guard', text: 'One more breath for the banner. Then let the rest of us sleep.' }], tags: ['elite', 'courage'] }, { id: 'lieutenant_pride', title: 'Lieutenant - Pride', mono: true, lines: [{ speaker: 'lieutenant_hu', text: 'A lieutenant is the hand of command; I bend and the field obeys.' }], tags: ['elite', 'lieutenant'] }, { id: 'lieutenant_undermine', title: 'Lieutenant - Undermine', lines: [{ speaker: 'lieutenant_hu', text: 'We will cut the supply line first. A hungry army is an angry one.' }], tags: ['elite', 'tactic'] }, { id: 'npc_launderer_tip', title: 'NPC - Launderer Tip', lines: [{ speaker: 'npc_launderer', text: 'Wash the red from the hem before you mend it — stains remember wrong hands.' }], tags: ['npc', 'tip'] }, { id: 'npc_tavern_banter', title: 'NPC - Tavern Banter', lines: [{ speaker: 'npc_barkeep', text: 'If you have coin, I have a story. If you have no coin, I have the same story for free.' }], tags: ['npc', 'banter'] }, { id: 'npc_hook_old_map', title: 'NPC - Old Map Hook', lines: [{ speaker: 'npc_oldman', text: 'Bring me that ragged map and I will tell you where the well hides a secret path.' }], tags: ['npc', 'quest'] }, { id: 'npc_hook_lost_ring', title: 'NPC - Lost Ring Hook', lines: [{ speaker: 'npc_widow', text: 'My ring fell where the lantern light dies. Bring it back and I will trade a blessing.' }], tags: ['npc', 'quest'] }, { id: 'combat_death_throe', title: 'Combat - Death Throe', mono: true, lines: [{ speaker: 'combat_generic', text: 'My breath leaves me like a poor coin — small and not worth much.' }], tags: ['combat', 'death'] }, { id: 'combat_one_liner_slam', title: 'Combat - One Liner Slam', lines: [{ speaker: 'combat_generic', text: 'Feel the weight of your choices!' }], tags: ['combat', 'taunt'] }, { id: 'micro_reflect_1', title: 'Micro Reflect 1', mono: true, lines: [{ speaker: 'narrator', text: 'A small mercy carries further than a grand promise.' }], tags: ['reflect', 'micro'] }, { id: 'micro_reflect_2', title: 'Micro Reflect 2', mono: true, lines: [{ speaker: 'narrator', text: 'The path is a conversation; sometimes you must listen more than speak.' }], tags: ['reflect', 'micro'] });
exports.default = EXTENDED_MONOLOGUES;
