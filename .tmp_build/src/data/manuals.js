...
exports.scaleManualEffects = exports.getRealmMultiplier = exports.ALL_MANUALS = exports.MANUALS = void 0;
...
// Create all manuals
exports.MANUALS = MANUAL_NAMES.map((name, index) => createManual(name, index, MANUAL_NAMES.length));
// Helpers: realm-scaled accessors for manuals
function getManualById(id) {
    return exports.ALL_MANUALS.find(m => m.id === id);
}
function getScaledManualEffects(m, realm) {
    return (0, scalingSystem_1.scaleManualEffects)(m.effects, realm);
}
function getManualByIdScaled(id, realm) {
...
const ORIGINAL_MAIN_CHARACTER_MANUALS = [
    {
...
Object.defineProperty(exports, "scaleManualEffects", { enumerable: true, get: function () { return scalingSystem_2.scaleManualEffects; } });
