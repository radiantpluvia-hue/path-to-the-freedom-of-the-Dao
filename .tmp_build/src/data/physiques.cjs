...
exports.scaleCultivationSpeed = exports.scalePhysiqueStats = exports.getRealmMultiplier = exports.ALL_PHYSIQUES = exports.PHYSIQUES = void 0;
...
function generatePhysiqueId(name) {
...
function createPhysique(name, index, total) {
    ...
    const rarityKey = BASE_STATS[rarity]
        ? rarity
        : (LEGACY_TO_LETTER[(rarity || '').toString().toLowerCase()] || rarity);
    const baseStats = BASE_STATS[rarityKey];
    const baseCultivationSpeed = BASE_CULTIVATION_SPEED[rarityKey];
...
exports.PHYSIQUES = PHYSIQUE_NAMES.map((name, index) => createPhysique(name, index, PHYSIQUE_NAMES.length));
// Keep original main character physiques and add them to the beginning
const ORIGINAL_MAIN_CHARACTER_PHYSIQUES = [
    {
        id: 'su_ming_physique',
...
Object.defineProperty(exports, "scalePhysiqueStats", { enumerable: true, get: function () { return scalingSystem_2.scalePhysiqueStats; } });
Object.defineProperty(exports, "scaleCultivationSpeed", { enumerable: true, get: function () { return scalingSystem_2.scaleCultivationSpeed; } });
