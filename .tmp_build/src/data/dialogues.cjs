...
exports.DIALOGUES = void 0;
const character_monologues_extended_1 = __importDefault(require("./character_monologues_extended"));
...
try {
    if (Array.isArray(character_monologues_extended_1.default) && character_monologues_extended_1.default.length) {
        // mutate the DIALOGUES array in-place so existing imports/readers continue to work
        exports.DIALOGUES.push(...character_monologues_extended_1.default);
    }
}
catch (e) {
    // non-fatal if the import fails in some test environments
}
exports.default = exports.DIALOGUES;
