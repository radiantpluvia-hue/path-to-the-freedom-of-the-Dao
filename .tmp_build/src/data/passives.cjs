...
exports.PASSIVES = [
    ...
    { id: 'passive_leader_aura', name: 'Leader Aura', tier: 'mortal', atk: 2, def: 2, description: 'An aura that bolsters nearby allies.', tags: ['support'] },
    { id: 'passive_veteran_tactics', name: 'Veteran Tactics', tier: 'mortal', atk: 3, def: 1, description: 'Grants improved formation coordination.', tags: ['formation'] },
    { id: 'passive_shieldwall', name: 'Shieldwall Discipline', tier: 'mortal', def: 4, description: 'Increases party defense when anchored.', tags: ['defense'] },
    { id: 'passive_ranged_accuracy', name: 'Ranged Accuracy', tier: 'mortal', atk: 2, description: 'Improves ranged hit chance and damage.', tags: ['ranged'] },
    { id: 'passive_scouting_instincts', name: 'Scouting Instincts', tier: 'mortal', speedPct: 5, description: 'Improves initiative and detection.', tags: ['utility'] },
    { id: 'passive_berserker_rage', name: 'Berserker Rage', tier: 'mortal', atk: 5, description: 'Temporarily increases attack after taking heavy damage.', tags: ['offense'] },
    { id: 'passive_steel_will', name: 'Steel Will', tier: 'mortal', def: 3, qiMax: 10, description: 'Reduces the duration of crowd-control effects.', tags: ['utility'] },
    { id: 'passive_inspiring_cry', name: 'Inspiring Cry', tier: 'mortal', atkPct: 5, description: 'Boosts allies attack percentage briefly upon entering combat.', tags: ['support'] },
    { id: 'passive_hunter_mark', name: 'Hunter Mark', tier: 'mortal', atk: 3, description: 'Marks a target to increase subsequent damage.', tags: ['ranged', 'single-target'] },
    { id: 'passive_siege_mastery', name: 'Siege Mastery', tier: 'mortal', atk: 4, description: 'Enhances damage against anchored formations.', tags: ['siege'] },
    { id: 'passive_stealth_shroud', name: 'Stealth Shroud', tier: 'mortal', speedPct: 8, description: 'Grants a temporary stealth window at range.', tags: ['stealth'] },
    { id: 'passive_trap_expert', name: 'Trap Expert', tier: 'mortal', description: 'Increases trap damage and detection likelihood.', tags: ['utility'] },
    { id: 'passive_rallying_banner', name: 'Rallying Banner', tier: 'mortal', def: 2, qiMax: 5, description: 'Provides small passive morale recovery to allies.', tags: ['support'] },
    { id: 'passive_piercing_precision', name: 'Piercing Precision', tier: 'mortal', atk: 3, description: 'Ignores a portion of enemy defenses on hit.', tags: ['offense'] },
    { id: 'passive_endurance_training', name: 'Endurance Training', tier: 'mortal', hp: 20, description: 'Increases max HP through conditioning.', tags: ['survival'] },
    { id: 'passive_stun_chance', name: 'Stun Chance', description: 'Small chance to stun on hit.', tags: ['control', 'offense'], tier: 1 },
    { id: 'passive_bleed_on_hit', name: 'Bleed on Hit', description: 'Deal small bleeding damage over time.', tags: ['dot', 'offense'], tier: 1 },
