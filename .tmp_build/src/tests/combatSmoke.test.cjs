...
describe('CombatSystem smoke tests', () => {
    ...
    test('stance change and mastery rank increments end-to-end', () => {
        ...
        const context = { type: 'normal', debugDamageBreakdown: false };
        const system = new CombatSystem_1.CombatSystem(player, [enemy], undefined, undefined, context);
    ...
    test('enemy telegraphs intent before acting', () => {
        ...
        const system = new CombatSystem_1.CombatSystem(player, [enemy], undefined, undefined, { type: 'normal' });
