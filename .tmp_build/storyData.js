...
const realmHelpers_1 = require("./src/utils/realmHelpers");
exports.storyActs = [
    {
        id: 'act1',
                ...
                objectives: [
                    {
                        ...
                        isCompleted: (state) => (0, realmHelpers_1.getRealmKeyFromPlayer)(state.player) === 'qi_condensation',
                    },
                    {
            ...
            'forging_the_path': {
                ...
                objectives: [
                    ...
                    },
                    {
                        ...
                        isCompleted: (state) => (0, realmHelpers_1.getRealmKeyFromPlayer)(state.player) === 'foundation_establishment',
                    },
                ],
            },
        },
            ...
            'unfolding_world': {
                ...
                objectives: [
                    ...
                    },
                    {
                        ...
                        isCompleted: (state) => (0, realmHelpers_1.getRealmKeyFromPlayer)(state.player) === 'core_formation',
                    },
                ],
            },
        },
            ...
            'soul_of_ones_own': {
                ...
                objectives: [
                    ...
                    },
                    {
                        ...
                        type: 'realm_check',
                        target: 'nascent_soul',
                        isCompleted: (state) => (0, realmHelpers_1.getRealmKeyFromPlayer)(state.player) === 'nascent_soul',
                    },
                ],
            },
        },
            ...
            'price_of_power': {
                ...
                objectives: [
                    ...
                    },
                    {
                        ...
                        isCompleted: (state) => (0, realmHelpers_1.getRealmKeyFromPlayer)(state.player) === 'spirit_severing',
                    },
                ],
            },
        },
            ...
            'immortal_threshold': {
                ...
                objectives: [
                    ...
                    },
                    {
                        ...
                        type: 'realm_check',
                        target: 'immortal',
                        isCompleted: (state) => (0, realmHelpers_1.getRealmKeyFromPlayer)(state.player) === 'immortal' || state.world.flags['player_perished'] === true,
                    },
                ],
            },
        },
